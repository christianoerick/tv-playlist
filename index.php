...
<?php foreach($tv->getMenu() as $menu_chave => $menu_item) { ?>
...
<?php } else { ?>
              <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: Thumbnail"><title><?php echo $item['nome']; ?></title><rect width="100%" height="100%" fill="#000"/><text x="50%" y="50%" fill="#eceeef" dy=".3em"><?php echo $item['nome']; ?></text></svg>
<?php } ?>
              </a>
          </div>
        </div>
